...
How long will the bus journey take? Alternatively, you could run to university. You jog the first mile at 7 m/h;
then run the next two at 15 m/h; before jogging the last at 7m/h again. Will this be quicker or slower than the bus.
'''
